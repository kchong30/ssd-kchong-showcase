    ...
    <x-slot name="content">
      <main class="max-w-lg mx-auto">
        ...
        @endif
          ...
          <div class="mb-6">
            <label for="published_date" class="block mb-2 uppercase font-bold text-xs text-gray-700">Published Date</label>
              <input type="date" name="published_date" id="published_date" class="border border-gray-400 rounded p2 w-full" value = "{{old('published_date') ?? $project?->published_date}}">
